...
const defaultPromo = {
  color: '0 100% 100%',
  content:
    'Docs is developer documentation written in a language that is easy to understand. It is written by the community to help each other. Your knowledge and experience are valuable. Share them, we will help.',
  design: 'default',
  links: [
    {
      emoji: '🙌',
...
module.exports = {
  ...
  permalink: '/',
  documentTitle: 'Docs',
  documentDescription: 'Developer documentation written in a language that is easy to understand',
